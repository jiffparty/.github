...
Matrix room: add directly to your Matrix client's address `#jiffparty:unredacted.org`, or use [this link](https://element.unredacted.org/#/room/#jiffparty:unredacted.org) if you don't have a Matrix account yet (no phone/email is required).
...
_P.S. Don't mind the third-party repositories; their presence only indicates that yet another technical assistance is ongoing. They will be deleted._
